...
function savePurchase(state, values, preserved = {}) {
  ...
  const document = preserved.document || documentNo(state.settings.purchasePrefix, state.purchases);
...
function saveServicePurchase(state, values, preserved = {}) {
  ...
  const document = preserved.document || documentNo("SRV", state.servicePurchases);
